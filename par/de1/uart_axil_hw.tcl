...
add_interface_port altera_axi4lite_slave_1 araddr_i araddr Input ADDR_WIDTH
...
add_interface_port altera_axi4lite_slave_1 awaddr_i awaddr Input ADDR_WIDTH
