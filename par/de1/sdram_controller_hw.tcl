...
set_module_property GROUP riscy
...
set_module_assignment embeddedsw.dts.name "sdram_controller"
set_module_assignment embeddedsw.dts.group "riscy"
...
add_fileset_file sdr_parameters.svh VERILOG_INCLUDE PATH ../../rtl/mem/sdram/sdr_parameters.svh
...
# 
# connection point sdram_bus
# 
add_interface sdram_bus conduit end
set_interface_property sdram_bus associatedClock clock
set_interface_property sdram_bus associatedReset ""
set_interface_property sdram_bus ENABLED true
set_interface_property sdram_bus EXPORT_OF ""
set_interface_property sdram_bus PORT_NAME_MAP ""
set_interface_property sdram_bus CMSIS_SVD_VARIABLES ""
set_interface_property sdram_bus SVD_ADDRESS_GROUP ""

add_interface_port sdram_bus sdram_addr addr Output 13
add_interface_port sdram_bus sdram_ba ba Output 2
add_interface_port sdram_bus sdram_cas_n cas_n Output 1
add_interface_port sdram_bus sdram_cke cke Output 1
add_interface_port sdram_bus sdram_clk clk Output 1
add_interface_port sdram_bus sdram_cs_n cs_n Output 1
add_interface_port sdram_bus sdram_dq dq Bidir 16
add_interface_port sdram_bus sdram_dqm dqm Output 2
add_interface_port sdram_bus sdram_ras_n ras_n Output 1
add_interface_port sdram_bus sdram_we_n we_n Output 1
