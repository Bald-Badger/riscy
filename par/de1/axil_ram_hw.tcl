...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL axil_ram_og
...
add_fileset_file axil_ram_og.v VERILOG PATH ../../rtl/verilog-axi/rtl/axil_ram_og.v TOP_LEVEL_FILE
