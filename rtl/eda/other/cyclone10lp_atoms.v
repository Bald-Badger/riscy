...
primitive CYCLONE10LP_PRIM_DFFE (Q, ENA, D, CLK, CLRN, PRN, notifier);
   input D;   
   input CLRN;
   input PRN;
   input CLK;
...
primitive CYCLONE10LP_PRIM_DFFEAS (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
...
primitive CYCLONE10LP_PRIM_DFFEAS_HIGH (q, d, clk, ena, clr, pre, ald, adt, sclr, sload, notifier  );
    input d,clk,ena,clr,pre,ald,adt,sclr,sload, notifier;
    output q;
    reg q;
    initial
...
module cyclone10lp_dffe ( Q, CLK, ENA, D, CLRN, PRN );
   input D;
   input CLK;
   input CLRN;
   input PRN;
   ...
   CYCLONE10LP_PRIM_DFFE ( Q, ENA_ipd, D_ipd, CLK_ipd, CLRN_ipd, PRN_ipd, viol_notifier );
...
module cyclone10lp_mux21 (MO, A, B, S);
   input A, B, S;
   output MO;
...
module cyclone10lp_mux41 (MO, IN0, IN1, IN2, IN3, S);
   input IN0;
   input IN1;
   input IN2;
   input IN3;
...
module cyclone10lp_and16 (Y, IN1);
   input [15:0] IN1;
   output [15:0] Y;
...
module cyclone10lp_bmux21 (MO, A, B, S);
   input [15:0] A, B;
   input 	S;
   output [15:0] MO; 
...
module cyclone10lp_b17mux21 (MO, A, B, S);
   input [16:0] A, B;
   input 	S;
   output [16:0] MO; 
...
module cyclone10lp_nmux21 (MO, A, B, S);
   input A, B, S; 
   output MO; 
...
module cyclone10lp_b5mux21 (MO, A, B, S);
   input [4:0] A, B;
   input       S;
   output [4:0] MO; 
...
module cyclone10lp_latch(D, ENA, PRE, CLR, Q);
...
//------------------------------------------------------------------
//
// Module Name : cyclone10lp_routing_wire
//
...
module cyclone10lp_routing_wire (
                               datain,
                               dataout
                               );
...
endmodule // cyclone10lp_routing_wire
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : cyclone10lp_m_cntr
//
// Description : Timing simulation model for the M counter. This is the
//               loop feedback counter for the CYCLONE10LP PLL.
//
///////////////////////////////////////////////////////////////////////////////

`timescale 1 ps / 1 ps
module cyclone10lp_m_cntr   ( clk,
                            reset,
                            cout,
                            initial_value,
                            modulus,
...
endmodule // cyclone10lp_m_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : cyclone10lp_n_cntr
//
// Description : Timing simulation model for the N counter. This is the
//               input clock divide counter for the CYCLONE10LP PLL.
//
///////////////////////////////////////////////////////////////////////////////

`timescale 1 ps / 1 ps
module cyclone10lp_n_cntr   ( clk,
                            reset,
                            cout,
                            modulus);
...
endmodule // cyclone10lp_n_cntr

///////////////////////////////////////////////////////////////////////////////
//
// Module Name : cyclone10lp_scale_cntr
//
...
`timescale 1 ps / 1 ps
module cyclone10lp_scale_cntr   ( clk,
                                reset,
                                cout,
                                high,
                                low,
...
endmodule // cyclone10lp_scale_cntr

//BEGIN MF PORTING DELETE
///////////////////////////////////////////////////////////////////////////////
//
// Module Name : cyclone10lp_pll_reg
//
...
endmodule // cyclone10lp_pll_reg
//END MF PORTING DELETE

//////////////////////////////////////////////////////////////////////////////
//
// Module Name : cyclone10lp_pll
//
...
module cyclone10lp_pll (inclk,
    ...
    parameter lpm_type = "cyclone10lp_pll";
...
// SIMULATION_ONLY_PARAMETERS_BEGIN
    ...
    parameter family_name = "Cyclone10lp";
...
// LOCAL_PARAMETERS_END
    ...
    // this is for cyclone10lp lvds only
...
// Determine the inclk1 frequency
    ...
    cyclone10lp_m_cntr m1 (.clk(inclk_m),
    ...
    cyclone10lp_n_cntr n1 (.clk(inclk_n),
                        .reset(areset),
                        .cout(refclk),
                        .modulus(n_val[0]));
...
always @(vco_out)
    ...
    cyclone10lp_scale_cntr c0 (.clk(inclk_c0),
                            .reset(areset  || stop_vco),
                            .cout(c0_clk),
                            .high(c_high_val[0]),
                            .low(c_low_val[0]),
    ...
    cyclone10lp_scale_cntr c1 (.clk(inclk_c1),
                            .reset(areset || stop_vco),
                            .cout(c1_clk),
                            .high(c_high_val[1]),
                            .low(c_low_val[1]),
    ...
    cyclone10lp_scale_cntr c2 (.clk(inclk_c2),
                            .reset(areset || stop_vco),
                            .cout(c2_clk),
                            .high(c_high_val[2]),
                            .low(c_low_val[2]),
    ...
    cyclone10lp_scale_cntr c3 (.clk(inclk_c3),
                            .reset(areset  || stop_vco),
                            .cout(c3_clk),
                            .high(c_high_val[3]),
                            .low(c_low_val[3]),
    ...
    cyclone10lp_scale_cntr c4 (.clk(inclk_c4),
                            .reset(areset || stop_vco),
                            .cout(c4_clk),
                            .high(c_high_val[4]),
                            .low(c_low_val[4]),
...
endmodule // cyclone10lp_pll
//------------------------------------------------------------------
//
// Module Name : cyclone10lp_lcell_comb
//
...
//------------------------------------------------------------------
//
// Module Name : cyclone10lp_ff
//
// Description : Cyclone10lp FF Verilog simulation model 
//
//------------------------------------------------------------------
`timescale 1 ps/1 ps
  
module cyclone10lp_ff (
    d, 
    clk, 
    clrn, 
    aload, 
...
parameter lpm_type = "cyclone10lp_ff";
...
module cyclone10lp_ram_pulse_generator (
                                    clk,
                                    ena,
                                    pulse,
                                    cycle
...
module cyclone10lp_ram_register (
                             d,
                             clk,
                             aclr,
                             devclrn,
...
//--------------------------------------------------------------------------
// Module Name     : cyclone10lp_ram_block
// Description     : Main RAM module
//--------------------------------------------------------------------------

module cyclone10lp_ram_block
    (
     portadatain,
     portaaddr,
     portawe,
...
parameter lpm_type = "cyclone10lp_ram_block";
...
// port A core active
cyclone10lp_ram_register active_core_port_a (
       .d(active_a_core_in),
       .clk(clk_a_in),
       .aclr(1'b0),
       .devclrn(1'b1),
...
// port B core active
cyclone10lp_ram_register active_core_port_b (
       .d(active_b_core_in),
       .clk(clk_b_in),
       .aclr(1'b0),
       .devclrn(1'b1),
...
// ------- A input registers -------
// write enable
cyclone10lp_ram_register we_a_register (
...
// read enable
cyclone10lp_ram_register re_a_register (
        .d(portare_int),
        .clk(clk_a_rena),
        .aclr(re_a_clr_in),
        .devclrn(devclrn),
...
// address
cyclone10lp_ram_register addr_a_register (
        .d(portaaddr_int),
        .clk(clk_a_in),
        .aclr(addr_a_clr_in),
...
// data
cyclone10lp_ram_register datain_a_register (
        .d(portadatain_int),
        .clk(clk_a_in),
...
// byte enable
cyclone10lp_ram_register byteena_a_register (
...
cyclone10lp_ram_register we_b_register (
        .d(portbwe_int),
        .clk(clk_b_wena),
        .aclr(we_b_clr_in),
        .stall(1'b0),
...
cyclone10lp_ram_register re_b_register (
        .d(portbre_int),
        .clk(clk_b_rena),
        .aclr(re_b_clr_in),
        .stall(1'b0),
...
// address
cyclone10lp_ram_register addr_b_register (
        .d(portbaddr_int),
        .clk(clk_b_in),
        .aclr(addr_b_clr_in),
        .devclrn(devclrn),
...
// data
cyclone10lp_ram_register datain_b_register (
        .d(portbdatain_int),
        .clk(clk_b_in),
...
// byte enable
cyclone10lp_ram_register byteena_b_register (
...
cyclone10lp_ram_pulse_generator wpgen_a (
       .clk(clk_a_in),
...
cyclone10lp_ram_pulse_generator wpgen_b (
       .clk(clk_b_in),
...
cyclone10lp_ram_pulse_generator rpgen_a (
        .clk(clk_a_in),
...
cyclone10lp_ram_pulse_generator rpgen_b (
        .clk(clk_b_in),
...
begin
 ...
 // port A
 cyclone10lp_ram_register aclr__a__mux_register (
        .d(dataout_a_clr),
        .clk(clk_a_core),
        .aclr(1'b0),
        .devclrn(devclrn),
 ...
 // port B
 cyclone10lp_ram_register aclr__b__mux_register (
        .d(dataout_b_clr),
        .clk(clk_b_core),
        .aclr(1'b0),
        .devclrn(devclrn),
...
cyclone10lp_ram_register dataout_a_register (
        .d(dataout_a),
        .clk(clk_a_out),
...
cyclone10lp_ram_register dataout_b_register (
        .d( dataout_b ),
        .clk(clk_b_out),
...
endmodule // cyclone10lp_ram_block
...
`timescale 1 ps/1 ps
module cyclone10lp_mac_data_reg (clk,
                               data,
                               ena,
                               aclr,
                               dataout
...
endmodule //cyclone10lp_mac_data_reg
...
module cyclone10lp_mac_sign_reg (
                               clk,
                               d,
                               ena,
                               aclr,
...
endmodule // cyclone10lp_mac_sign_reg
...
module cyclone10lp_mac_mult_internal
   (
    dataa, 
    datab,
    signa, 
...
module cyclone10lp_mac_mult	
   (
    ...
    parameter lpm_hint       = "true";
    parameter lpm_type       = "cyclone10lp_mac_mult";
...
// SIMULATION_ONLY_PARAMETERS_END
    ...
    cyclone10lp_mac_data_reg dataa_reg (
                                      .clk(clk),
                                      .data(dataa_pad),
                                      .ena(ena),
                                      .aclr(reg_aclr),
    ...
    cyclone10lp_mac_data_reg datab_reg (
                                      .clk(clk),
                                      .data(datab_pad),
                                      .ena(ena),
                                      .aclr(reg_aclr),
    ...
    cyclone10lp_mac_sign_reg signa_reg (
                                      .clk(clk),
                                      .d(signa),
                                      .ena(ena),
                                      .aclr(reg_aclr),
    ...
    cyclone10lp_mac_sign_reg signb_reg (
                                      .clk(clk),
                                      .d(signb),
                                      .ena(ena),
                                      .aclr(reg_aclr),
    ...
    cyclone10lp_mac_mult_internal mac_multiply (
...
module cyclone10lp_mac_out	
   (
    ...
    parameter lpm_hint      = "true";
    parameter lpm_type      = "cyclone10lp_mac_out";
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    cyclone10lp_io_ibuf                                 //
//Description:                    Simulation model for Cyclone10lp IO Input Buffer    //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

// Deactivate the following LEDA rules for cyclone10lp_io_atom.v
...
parameter lpm_type = "cyclone10lp_io_ibuf";
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    cyclone10lp_io_obuf                                 //
//Description:                    Simulation model for Cyclone10lp IO Output Buffer   //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
parameter bus_hold = "false";
parameter lpm_type = "cyclone10lp_io_obuf";
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    cyclone10lp_ddio_out                                //
//Description:                    Simulation model for Cyclone10lp DDIO Output        //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////

module cyclone10lp_ddio_out (
                        datainlo,
                        datainhi,
                        clk,
                        clkhi,
...
parameter lpm_type = "cyclone10lp_ddio_out";
...
wire bdataout;                          
cyclone10lp_routing_wire wire_delay (    
.datain(bdataout),                      
.dataout(dataout)                       
);                                      

//registered output selection
cyclone10lp_mux21 sel_mux(
                    .MO(bdataout),  
                    .A(sel_mux_hi_in),
                    .B(sel_mux_lo_in),
                    .S(!muxsel_tmp)
...
//////////////////////////////////////////////////////////////////////////////////
//Module Name:                    cyclone10lp_ddio_oe                                 //
//Description:                    Simulation model for Cyclone10lp DDIO OE            //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
module cyclone10lp_ddio_oe (
                       oe,
                       clk,
                       ena,
                       areset,
...
parameter async_mode = "none";
parameter sync_mode = "none";
parameter lpm_type = "cyclone10lp_ddio_oe";
...
// Deactivate the following LEDA rules for cyclone10lp_pseudo_diff_atom.v
// G_521_3B: Use uppercase letters for all parameter names
// leda G_521_3_B off

module cyclone10lp_pseudo_diff_out(
                             i,
                             o,
                             obar
                             );
parameter lpm_type = "cyclone10lp_pseudo_diff_out";
...
module cyclone10lp_io_pad ( 
		      padin, 
                      padout
	            );

parameter lpm_type = "cyclone10lp_io_pad";
//INPUT PORTS
...
//---------------------------------------------------------------------
//
// Module Name : cyclone10lp_asmiblock
//
...
parameter lpm_type = "cyclone10lp_asmiblock";
...
endmodule  // cyclone10lp_asmiblock
//------------------------------------------------------------------
//
// Module Name : cyclone10lp_ena_reg
//
// Description : Simulation model for a simple DFF.
...
endmodule // cyclone10lp_ena_reg

//------------------------------------------------------------------
//
// Module Name : cyclone10lp_clkctrl
//
...
parameter lpm_type = "cyclone10lp_clkctrl";
...
cyclone10lp_mux41 clk_mux (.MO(clkmux_out),
               .IN0(inclk0_ipd),
               .IN1(inclk1_ipd),
               .IN2(inclk2_ipd),
               .IN3(inclk3_ipd),
...
cyclone10lp_ena_reg extena0_reg(
                    .clk(!clkmux_out),
                    .ena(1'b1),
                    .d(ena_ipd),
                    .clrn(1'b1),
...
cyclone10lp_ena_reg extena1_reg(
                    .clk(!clkmux_out),
                    .ena(1'b1),
                    .d(cereg1_out),
                    .clrn(1'b1),
...
///////////////////////////////////////////////////////////////////////
//
//              	CYCLONE10LP RUBLOCK ATOM 
//
///////////////////////////////////////////////////////////////////////

`timescale 1 ps/1 ps
module  cyclone10lp_rublock 
	(
	clk, 
	shiftnld, 
	captnupdt, 
	...
	parameter lpm_type = "cyclone10lp_rublock";
...
///////////////////////////////////////////////////////////////////////
//
//              	CYCLONE10LP_APFCONTROLLER ATOM 
//
///////////////////////////////////////////////////////////////////////

`timescale 1 ps/1 ps
module  cyclone10lp_apfcontroller 
	(
	usermode,
	nceout 
	);

	parameter lpm_type = "cyclone10lp_apfcontroller";
...
//------------------------------------------------------------------
//
// Module Name : cyclone10lp_termination_ctrl_sub
//
// Description : Cyclone10lp Termination Ctrl Sub-block 
//          
//------------------------------------------------------------------

`timescale 1 ps/1 ps

module cyclone10lp_termination_ctrl (
    clkusr,
    intosc,
    nclrusr,
    nfrzdrv,
...
module cyclone10lp_termination_rupdn (
    clken, 
    clkin, 
    compout, 
    maskbit, 
...
//
// Description : Cyclone10lp Termination Atom Verilog simulation model 
//          
//------------------------------------------------------------------

`timescale 1 ps/1 ps

module cyclone10lp_termination (
    rup,
    rdn,
    terminationclock,
    terminationclear,
...
parameter lpm_type = "cyclone10lp_termination";
...
cyclone10lp_termination_ctrl m_ctrl (
    .clken          (xcbout_clken          ), 
    .clkin          (xcbout_clkin          ), 
...
cyclone10lp_termination_rupdn m_rup (
    .compout        (rup_compout    ), 
    .octrpcd        (rup_octrupn    ), 
...
cyclone10lp_termination_rupdn m_rdn (
    .compout        (rdn_compout    ), 
    .octrpcd        (rdn_octrdnp    ), 
...
//--------------------------------------------------------------------
//
// Module Name : cyclone10lp_jtag
//
// Description : Cyclone10lp JTAG Verilog Simulation model
//
//--------------------------------------------------------------------

`timescale 1 ps/1 ps
module  cyclone10lp_jtag (
    tms, 
    tck,
    tdi, 
    tdoutap,
...
parameter lpm_type = "cyclone10lp_jtag";

endmodule

//--------------------------------------------------------------------
//
// Module Name : cyclone10lp_crcblock
//
// Description : Cyclone10lp CRCBLOCK Verilog Simulation model
//
//--------------------------------------------------------------------

`timescale 1 ps/1 ps
module  cyclone10lp_crcblock (
    clk,
    shiftnld,
    ldsrc,
    crcerror,
...
parameter lpm_type = "cyclone10lp_crcblock";

endmodule

///////////////////////////////////////////////////////////////////////
//
//              	CYCLONE10LP OSCILLATOR ATOM 
//
///////////////////////////////////////////////////////////////////////

`timescale 1 ps/1 ps
module  cyclone10lp_oscillator 
    (
    oscena,
    clkout 
    );

    parameter lpm_type = "cyclone10lp_oscillator";
